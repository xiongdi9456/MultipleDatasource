...
public class ClusterDBConfig {
    ...
    ///////////////////////////////////////////////////////
    //cluster dao 所在的包
    public static final String PACKAGE = "com.sheldon.multipledatasource.dao.cluster";
    //mapper所在目录
    ...
    @Value("${cluster.datasource.publickey}")
    ...
    public SqlSessionFactory clusterSqlSessionFactory(@Qualifier("clusterDataSource") DataSource clusterDataSource) throws Exception{
        ...
        Resource[] mapperLocations = new PathMatchingResourcePatternResolver().getResources(ClusterDBConfig.MAPPER_LOCATION);
